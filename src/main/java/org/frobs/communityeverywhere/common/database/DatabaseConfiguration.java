...
public interface DatabaseConfiguration {
    ...
    public static final String DB_URL = "jdbc:mysql://localhost/community_everywhere?useLegacyDatetimeCode="+JDBC_LEGACY_DATETIME+"&serverTimezone=" + JDBC_TIMEZONE + "&useSSL=" + JDBC_USESSL;
